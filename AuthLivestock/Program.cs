using AuthLivestock.Example.Endpoints;
using AuthLivestock.Example.Services;
using AuthLivestock.Utils;
using AuthLivestock.Utils.Http;
using AuthLivestock.Utils.Mongo;
using FluentValidation;
using System.Diagnostics.CodeAnalysis;
using AuthLivestock.Config;
using AuthLivestock.Utils.Logging;
using Serilog;
